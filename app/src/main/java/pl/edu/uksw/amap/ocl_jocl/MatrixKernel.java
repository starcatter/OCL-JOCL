...
class MatrixKernel extends OclKernelWrapper {

    public MatrixKernel(OclContextWrapper contextWrapper, String kernelSource) {
    ...
    public void multiplyMatrix(float[] srcArrayA, float[] srcArrayB, float[] dstArray, int m, int n, int p) {
        ...
        clEnqueueNDRangeKernel(contextWrapper.getCommandQueue(), kernel, 1, null,
                new long[]{dstArray.length}, null, 0, null, null);
